"""Detection models and aggregate reporting for Cairo & Starknet static analysis."""
...
@dataclass
class Detection:
    """Individual pattern detection or hazard finding in Cairo."""

    pattern_type: PatternType
    pattern_category: PatternCategory
    target_name: str
    target_kind: str  # "contract", "component", "interface", "storage", "fn", "event", "trait"
    ...
    def summary(self) -> str:
        ...
        return f"Cairo architectural pattern: {self.pattern_type.value}"
...
class DetectionReport:
    """Aggregate scan result containing all detections across a Cairo project."""
