"""Domain service evaluating pattern detection rules on Cairo CodeModel."""
...
class RuleEngineService:
    """Evaluates rules against a Cairo CodeModel with confidence thresholding and filtering."""
