"""Application scanning service orchestrating Cairo & Starknet pattern detection."""
...
class ScanningService(ScannerPort):
    """Coordinates discovering, parsing, rule evaluation, and exporting for Cairo smart contracts."""
